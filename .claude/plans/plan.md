...
- [x] Первый релиз 1.0.0 (iOS, без монетизации) — отправлен на ревью 2026-09-14, **отклонён 2026-09-17 по 4.3(b) Design — Spam** (шаблонный отказ по жанру suika; аккаунт чистый, отказ первый). Дальше — план 1.1 (см. статус вверху); процесс: [my_docs/RELEASE_PROCESS.md](../my_docs/RELEASE_PROCESS.md)
