...
- [ ] Нативный LaunchScreen (storyboard iOS / Android splash) с иконкой — до старта Flutter пока белый экран
...
## Бэклог / идеи
- Локализация (сейчас все строки — русские литералы в виджетах; названия фруктов — `BallTier.title`) + пункт «Язык» в настройках
