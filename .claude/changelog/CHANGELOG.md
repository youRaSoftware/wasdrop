...
- Новое: куча фруктов в меню реагирует на наклон телефона — переверни, и они пересыплются к верху экрана
...
- New: the fruit pile in the menu follows the phone's tilt — turn it upside down and the fruit tumbles to the top
